...
{
    public class AgenceViewModel : BaseViewModel, IAgenceViewModel
    {
		private readonly NavigationManager Nav;
		private IEnumerable<CompetenceTechnoViewObject> CompetenceTechnoViews;
		private readonly IJSRuntime JSRuntime;

		public AgenceViewModel(IHermesContext contextHermes, ISnackbar snackbar, NavigationManager navigationManager, IJSRuntime jsRuntime) 
